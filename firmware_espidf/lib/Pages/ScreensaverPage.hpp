...
private:
  ...
  /**
   * Update the display with new temperature
   */
  static void _update_displayed_temperature();
  ...
  // The current temperature that is to be displayed
  static inline MutexWrapped<std::string> _current_temperature;
