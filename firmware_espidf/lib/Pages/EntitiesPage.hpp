...
public:
   ...
   * @param display_type: What should be displayed
   */
  static void show(display_type_t display_type);
...
private:
  ...
  static inline std::atomic<display_type_t> _display_type = display_type_t::ENTITIES;
